...
API.onUpdate.connect(function () {
    ...
    if (g_currentState == 1) {
        ...
        // Header
        API.drawText("ID:Name", listX + listPadding, listY - listPadding / 2, 0.4, 255, 255, 0, 255, 0, 0, true, true, 0);
        ...
        for (var i = 0; i < listPageCount; i++) {
            ...
            API.drawText(player.id + player.name, listX + listPadding, listY + listPadding / 2 + listLine * (i + 1), 0.45, color[0], color[1], color[2], 255, 4, 0, true, true, 0);
